...
public class Number extends Primary implements ArrayElement {
    ...
    public Number(String d1, String r, String m1, String d2, int line, String d3, String e, String m2, String d4) {
        this.line = line;
