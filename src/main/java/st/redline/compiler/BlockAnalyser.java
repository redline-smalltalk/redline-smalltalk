...
public class BlockAnalyser implements NodeVisitor {
	...
	private final BlockAnalyserDelegate blockAnalyser;
	...
	public BlockAnalyser(String className, String packageName, int countOfArguments, boolean isClassMethod, Analyser containingAnalyser, Block thisBlock) {
		blockAnalyser = new BlockAnalyserDelegate(className, packageName, countOfArguments, isClassMethod, containingAnalyser, thisBlock);
	}

	public MethodAnalyser getBlockAnalyser() {
