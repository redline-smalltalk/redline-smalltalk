...
public class JvmMethodInsn extends JvmExpression {
	...
	public JvmMethodInsn(JvmOpcode jvmOpcode, StringConstant owner, StringConstant name, StringConstant description) {
